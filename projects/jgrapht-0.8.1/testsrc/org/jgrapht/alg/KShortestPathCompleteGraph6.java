 ...
 *
 * $Id: KShortestPathCompleteGraph6.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
    ...
    extends SimpleWeightedGraph
{
    ...
    public DefaultEdge e12;

    public DefaultEdge e13;

    public DefaultEdge e14;

    public DefaultEdge e23;

    public DefaultEdge e24;

    public DefaultEdge e34;

    public DefaultEdge eS1;

    public DefaultEdge eS2;

    public DefaultEdge eS3;

    public DefaultEdge eS4;

    private DefaultEdge e15;

    private DefaultEdge e25;

    private DefaultEdge e35;

    private DefaultEdge e45;

    private DefaultEdge eS5;

    //~ Constructors -----------------------------------------------------------

    public KShortestPathCompleteGraph6()
    {
        super(new TFUL_DefaultWeightedEdgeFactory());
