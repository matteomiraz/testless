    ...
    extends SimpleWeightedGraph
{
    ...
    public DefaultEdge edgeAD;

    public DefaultEdge edgeBT;

    public DefaultEdge edgeCB;

    public DefaultEdge edgeCT;

    public DefaultEdge edgeDE;

    public DefaultEdge edgeEC;

    public DefaultEdge edgeSA;

    public DefaultEdge edgeST;
