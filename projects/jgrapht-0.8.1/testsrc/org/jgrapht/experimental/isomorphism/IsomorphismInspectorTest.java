 ...
 * Contributor(s):   -
 *
 * $Id: IsomorphismInspectorTest.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
 */
    ...
    extends TestCase
{
    ...
    public void testEdgeComparator()
    {
        ...
        for (int i = 0; i < graphsArray.length; i++) {
        	WeightedGraph<Character, DefaultWeightedEdge> currGraph =
        		new DefaultDirectedWeightedGraph<Character, DefaultWeightedEdge>(
                		new TFUL_DefaultWeightedEdgeFactory());
        	
            graphsArray[i] = currGraph;
