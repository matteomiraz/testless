...
public class ObjectArray {
	...
	public ObjectArray() { }
	public ObjectArray(ObjectArray a) {
	...
	public void addHead(java.lang.Object o) {
		java.lang.Object[] old = array;
		array = new java.lang.Object[n+1];
		array[0] = o;
		for (int i = 0; i < n; i++)
			array[i+1] = old[i];
	...
	public void addTail(java.lang.Object o) {
		java.lang.Object[] old = array;
		array = new java.lang.Object[n + 1];
		for (int i = 0; i < n; i++)
			array[i] = old[i];
	...
	public void setHead(java.lang.Object o) {
		if(n <= 0) throw new PreconditionViolationException.Impl("Invalid precondition while manipulating the array", null);

		array[0] = o;
	}

	public void set(int n, java.lang.Object o) {
		if(n < 0 || n >= this.n) throw new PreconditionViolationException.Impl("Invalid precondition while manipulating the array", null);

		array[n] = o;
	}

	public void setTail(java.lang.Object o) {
		if(n <= 0) throw new PreconditionViolationException.Impl("Invalid precondition while manipulating the array", null);
