 ...
 * Contributor(s):   -
 *
 * $Id: RandomGraphGenerator.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
 */
 ...
 * @since Aug 6, 2005
 */
public class RandomGraphGenerator<V, E extends org.jgrapht.graph.DefaultEdge>
    implements GraphGenerator<V, E, V>
{
    ...
    public RandomGraphGenerator(int aNumOfVertexes, int aNumOfEdges, long randomSeed)
    {
    	Contracts.assertSmall(aNumOfVertexes);
    	Contracts.assertSmall(aNumOfEdges);
        ...
        this.randomizerSeed = randomSeed;
     ...
     * (non-Javadoc)
     *
     * @throwsa IllegalArgumentException if the aNumOfEdges passed in the
    ...
    public void generateGraph(
        ...
        Map<String, V> resultMap) throws IllegalArgumentException
    {
        resetRandomSeed();
     ...
     * @since Aug 6, 2005
     */
    public interface EdgeTopologyFactory<VV, EE extends org.jgrapht.graph.DefaultEdge>
    {
        /**
     ...
     * @since Aug 6, 2005
     */
    public class DefaultEdgeTopologyFactory<VV, EE extends org.jgrapht.graph.DefaultEdge>
