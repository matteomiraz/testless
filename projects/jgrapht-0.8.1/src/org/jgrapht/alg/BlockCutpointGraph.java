 ...
 * @since July 5, 2007
 */
public class BlockCutpointGraph<V, E extends org.jgrapht.graph.DefaultEdge>
    extends SimpleGraph<UndirectedGraph<V, E>, DefaultEdge>
{
    ...
    {
        super(new TFUL_DefaultEdgeFactory<UndirectedGraph<V, E>>());
        this.graph = graph;

        this.dfsTree =
            new SimpleDirectedGraph<V,  DefaultEdge>(
            		new TFUL_DefaultEdgeFactory<V>());
