...
abstract class AbstractPathElementList<V,
    E extends org.jgrapht.graph.DefaultEdge, T extends AbstractPathElement<V, E>>
    ...
    implements Cloneable
{
     ...
     *
     * @throwsa NullPointerException if the specified path-element is <code>
     * null</code>.
     * @throwsa IllegalArgumentException if <code>maxSize</code> is negative or
     * 0.
     */
    protected AbstractPathElementList(
        Graph<V, E> graph,
        int maxSize,
        T pathElement) throws IllegalArgumentException
    {
        if (maxSize <= 0) {
     ...
     *
     * @throwsa NullPointerException if the specified prevPathElementList or edge
     * is <code>null</code>.
     * @throwsa IllegalArgumentException if <code>maxSize</code> is negative or
     * 0.
     */
    protected AbstractPathElementList(
        ...
        E edge) throws IllegalArgumentException
    {
        if (maxSize <= 0) {
            throw new IllegalArgumentException("maxSize is negative or 0");
        }
