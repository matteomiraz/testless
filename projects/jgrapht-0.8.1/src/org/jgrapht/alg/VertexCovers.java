...
public abstract class VertexCovers
{
     ...
     * graph.
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> Set<V> find2ApproximationCover(Graph<V, E> g)
    {
        // C <-- {}
     ...
     * graph.
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> Set<V> findGreedyCover(UndirectedGraph<V, E> g)
    {
        // C <-- {}
        Set<V> cover = new HashSet<V>();
