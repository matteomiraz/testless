 ...
 *
 * $Id: KShortestPaths.java 689 2009-07-04 06:40:29Z perfecthash $
 *
 * Changes
 * -------
 ...
 * @since July 5, 2007
 */
public class KShortestPaths<V, E extends org.jgrapht.graph.DefaultEdge>
{
    // ~ Instance fields
    // --------------------------------------------------------
     ...
     *
     * @throwsa NullPointerException if the specified graph or startVertex is
     * <code>null</code>.
     * @throwsa IllegalArgumentException if nPaths is negative or 0.
     * @throwsa IllegalArgumentException if nMaxHops is negative or 0.
     */
    public KShortestPaths(
        Graph<V, E> graph,
        V startVertex,
        int nPaths,
        int nMaxHops) throws IllegalArgumentException
    {
