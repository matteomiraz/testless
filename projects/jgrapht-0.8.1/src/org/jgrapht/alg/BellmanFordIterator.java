 ...
 * use.
 */
class BellmanFordIterator<V, E extends org.jgrapht.graph.DefaultEdge>
    implements Iterator<List<V>>
{
     ...
     * @param edge
     *
     * @throwsa IllegalArgumentException if the graph is undirected and the
     * edge-weight is negative.
     */
    protected void assertValidEdge(E edge) throws IllegalArgumentException
    {
