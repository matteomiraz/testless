 ...
 * @since Sep 2, 2003
 */
public final class DijkstraShortestPath<V, E extends org.jgrapht.graph.DefaultEdge>
{
    //~ Instance fields --------------------------------------------------------
     ...
     * @return List of Edges, or null if no path exists
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> List<E> findPathBetween(
        Graph<V, E> graph,
        V startVertex,
        V endVertex)
    {
