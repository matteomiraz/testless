 ...
 * @since Feb 2, 2005
 */
public class StrongConnectivityInspector<V, E extends org.jgrapht.graph.DefaultEdge>
{
    //~ Instance fields --------------------------------------------------------
     ...
     */
    public StrongConnectivityInspector(DirectedGraph<V, E> directedGraph) throws IllegalArgumentException
    {
