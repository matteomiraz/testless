...
public abstract class Graphs
{
     ...
     */
    public static <V, E extends org.jgrapht.graph.DefaultWeightedEdge> E addEdge(
    		WeightedGraph<V, E> g,
        V sourceVertex,
        V targetVertex,
        double weight)
     ...
     * null</code>.
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> E addEdgeWithVertices(
        Graph<V, E> g,
        V sourceVertex,
        V targetVertex)
    {
     ...
     * specified edge.
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> boolean addEdgeWithVertices(
     ...
     * null</code>.
     */
    public static <V, E extends org.jgrapht.graph.DefaultWeightedEdge> E addEdgeWithVertices(
    		WeightedGraph<V, E> g,
        V sourceVertex,
        V targetVertex,
        double weight)
     ...
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> boolean addGraph(
     ...
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> void addGraphReversed(
     ...
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> boolean addAllEdges(
        Graph<? super V, ? super E> destination,
        Graph<V, E> source,
     ...
     *
     * @throwsa NullPointerException if the specified vertices contains one or
     * more null vertices, or if the specified vertex collection is <tt>
     * null</tt>.
     *
     * @see Graph#addVertex(Object)
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> boolean addAllVertices(
        Graph<? super V, ? super E> destination,
     ...
     * vertex.
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> List<V> neighborListOf(Graph<V, E> g,
        V vertex)
    {
     ...
     * specified vertex.
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> List<V> predecessorListOf(
        DirectedGraph<V, E> g,
        V vertex)
    {
     ...
     * specified vertex.
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> List<V> successorListOf(
        DirectedGraph<V, E> g,
        V vertex)
    {
     ...
     *
     * @throwsa IllegalArgumentException if the graph is neither DirectedGraph
     * nor UndirectedGraph.
     *
     * @see AsUndirectedGraph
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> UndirectedGraph<V, E> undirectedGraph(Graph<V, E> g) throws IllegalArgumentException
    {
     ...
     */
    public static <V, E extends org.jgrapht.graph.DefaultEdge> boolean testIncidence(Graph<V, E> g, E e, V v)
    {
