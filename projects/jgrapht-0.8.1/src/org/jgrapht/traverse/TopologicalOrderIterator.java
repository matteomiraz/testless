 ...
 *
 * $Id: TopologicalOrderIterator.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
 ...
 * @since Dec 18, 2004
 */
public class TopologicalOrderIterator<V, E extends org.jgrapht.graph.DefaultEdge>
    extends CrossComponentIterator<V, E, Object>
{
     ...
     * @return start vertex
     */
    private static <V, E extends org.jgrapht.graph.DefaultEdge> V initialize(
        DirectedGraph<V, E> dg,
        Queue<V> queue,
        Map<V, ModifiableInteger> inDegreeMap)
    {
