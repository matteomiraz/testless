 ...
 *                   Christian Hammer
 *
 * $Id: CrossComponentIterator.java 650 2008-12-24 20:44:06Z perfecthash $
 *
 * Changes
 * -------
 ...
 * @since Jan 31, 2004
 */
public abstract class CrossComponentIterator<V, E extends org.jgrapht.graph.DefaultEdge, D>
    extends AbstractGraphIterator<V, E>
{
     ...
     *
     * @throwsa IllegalArgumentException if <code>g==null</code> or does not
     * contain <code>startVertex</code>
     */
    public CrossComponentIterator(Graph<V, E> g, V startVertex) throws IllegalArgumentException
    {
        super();
     ...
     */
    static <V, E extends org.jgrapht.graph.DefaultEdge> Specifics<V, E> createGraphSpecifics(Graph<V, E> g)
    {
     ...
     * @since Aug 11, 2003
     */
    static class FlyweightEdgeEvent<VV, localE extends DefaultEdge>
     ...
     */
    private static class DirectedSpecifics<VV, EE extends org.jgrapht.graph.DefaultEdge>
     ...
     * is ignored.
     */
    private static class UndirectedSpecifics<VV, EE extends org.jgrapht.graph.DefaultEdge>
        extends Specifics<VV, EE>
    {
