 ...
 *
 * $Id: DefaultListenableGraph.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
 ...
 * 
 * <p>
 * This graph does <i>not</i> pass the hashCode and equals operations through to
 * the backing graph, but relies on <tt>Object</tt>'s <tt>equals</tt> and
 ...
 * @since Jul 20, 2003
 */
public class DefaultListenableGraph<V, E extends org.jgrapht.graph.DefaultEdge>
		extends GraphDelegator<V, E> implements ListenableGraph<V, E>,
		Cloneable {
	 ...
	 * 
	 * @throwsa IllegalArgumentException if the backing graph is already a
	 *          listenable graph.
	 */
	...
	public Object clone() {
		try {
			...
			DefaultListenableGraph<V, E> g = TypeUtil.uncheckedCast(
					super.clone(), typeDecl);
