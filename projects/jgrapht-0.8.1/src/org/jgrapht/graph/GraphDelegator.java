 ...
 * @since Jul 20, 2003
 */
public class GraphDelegator<V, E extends org.jgrapht.graph.DefaultEdge>
        ...
        Serializable
{
     ...
     *
     * @throwsa IllegalArgumentException iff <code>g==null</code>
     */
    public GraphDelegator(Graph<V, E> g) throws IllegalArgumentException
    {
        super();
    ...
    {
        ((WeightedGraph) delegate).setEdgeWeight((DefaultWeightedEdge) e, weight);
    }
}
