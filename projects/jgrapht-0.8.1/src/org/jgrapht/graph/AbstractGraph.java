 ...
 * @see UndirectedGraph
 */
public abstract class AbstractGraph<V, E extends org.jgrapht.graph.DefaultEdge>
    implements Graph<V, E>
{
     ...
     *
     * @throwsa NullPointerException if specified vertex is <code>null</code>.
     * @throwsa IllegalArgumentException if specified vertex does not exist in
     * this graph.
     */
    protected boolean assertVertexExist(V v) throws IllegalArgumentException
    {
        if (containsVertex(v)) {
            return true;
        } else if (v == null) {
