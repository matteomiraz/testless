 ...
 *                   Christian Hammer
 *
 * $Id: AbstractBaseGraph.java 675 2009-03-12 08:30:09Z perfecthash $
 *
 * Changes
 * -------
 ...
 * @since Jul 24, 2003
 */
public abstract class AbstractBaseGraph<V, E  extends org.jgrapht.graph.DefaultEdge>
        ...
        Serializable
{
     ...
     *
     * @throwsa NullPointerException if the specified edge factory is <code>
     * null</code>.
     */
     ...
     */
    public E addEdge(V sourceVertex, V targetVertex) throws java.lang.IllegalArgumentException
    {
     ...
     */
    public boolean addEdge(V sourceVertex, V targetVertex, E e) throws java.lang.ClassCastException, java.lang.IllegalArgumentException
    {
        if (e == null) {
            throw new NullPointerException();
     ...
     */
    public Set<E> edgesOf(V vertex)  throws java.lang.IllegalArgumentException
    {
