 ...
 * Contributor(s):   -
 *
 * $Id: PartiteRandomGraphGenerator.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
 ...
 * @since Sep 13, 2004
 */
public class PartiteRandomGraphGenerator<V, E extends org.jgrapht.graph.DefaultEdge>
    implements GraphGenerator<V, E, Object[]>
{
    ...
    public PartiteRandomGraphGenerator(
        int numVertices1,
        int numVertices2,
        int numEdges, long randomSeed) throws IllegalArgumentException
    {
    	Contracts.assertSmall(numVertices1);
    	Contracts.assertSmall(numVertices2);
    	Contracts.assertSmall(numEdges);
     ...
     * @throwsa IllegalArgumentException
     */
    public PartiteRandomGraphGenerator(int [] numVertices, int numEdges, long randomSeed) throws IllegalArgumentException
    {
        if (numEdges < 0) {
            throw new IllegalArgumentException("illegal number of edges");
        }
