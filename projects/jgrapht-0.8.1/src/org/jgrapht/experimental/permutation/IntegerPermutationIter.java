 ...
 * Contributor(s):   -
 *
 * $Id: IntegerPermutationIter.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
 */
        ...
        ArrayPermutationsIter
{
     ...
     * perm0=[1,2,3,4] perm1=[1,2,4,3] perm2=[1,3,2,4]
     */
    public intArray testful_getNext() {
    	return new intArray(getNext());
    }
    public int [] getNext()
    {
        if (!hasNext()) {
...
//            }
    ...
    public intArray testful_getCurrent() {
    	return new intArray(getCurrent());
    }
     ...
     */
    public intArray testful_nextPermutation() {
    	return new intArray(nextPermutation());
    }
