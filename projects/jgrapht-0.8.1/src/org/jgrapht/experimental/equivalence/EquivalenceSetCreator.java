...
public class EquivalenceSetCreator<E, C> {
	...
	public static tful.arrays.EquivalenceSetArray testful_createEqualityGroupOrderedArray(
			tful.arrays.ObjectArray p0,
			org.jgrapht.experimental.equivalence.EquivalenceComparator p1,
			java.lang.Object p2) {
		return new tful.arrays.EquivalenceSetArray(
				createEqualityGroupOrderedArray(p0 == null?null:p0.toArray(), p1, p2));
	}
	...
	public static tful.arrays.EquivalenceSetArray testful_createEqualityGroupOrderedArray(
			...
			java.lang.Object p2) {
		return new tful.arrays.EquivalenceSetArray(
				createEqualityGroupOrderedArray(p0, p1, p2));
	}
