 ...
 */
public class DirectedAcyclicGraph<V, E extends org.jgrapht.graph.DefaultEdge>
    extends SimpleDirectedGraph<V, E>
{
     ...
     * is returned
     *
     * @throwsa IllegalArgumentException If either fromVertex or toVertex is not
     * a member of the graph
     * @throwsa CycleFoundException if the edge would induce a cycle in the graph
     *
     * @see Graph#addEdge(Object, Object, Object)
     */
    public E addDagEdge(V fromVertex, V toVertex)
        throws CycleFoundException, IllegalArgumentException
    {
     ...
     */
    @Override public E addEdge(V sourceVertex, V targetVertex) throws java.lang.IllegalArgumentException
    {
        E result = null;
        try {
     ...
     *
     * @throwsa CycleFoundException if adding an edge (fromVertex, toVertex) to
     ...
     */
    @Override public boolean addEdge(V sourceVertex, V targetVertex, E edge) throws java.lang.ClassCastException, java.lang.IllegalArgumentException
    {
        boolean result;
        try {
     ...
     * detection
     *
     * @throwsa CycleFoundException if a cycle is discovered
     */
    private void dfsF(
        V vertex,
        Set<V> df,
    ...
    public interface Visited
    {
         ...
         * @param index
         *
         * @throwsa UnsupportedOperationException if the implementation doesn't
