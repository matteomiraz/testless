 ...
 * @since Jul 14, 2003
 */
public interface Graph<V, E extends DefaultEdge>
{
    //~ Methods ----------------------------------------------------------------
     ...
     * null</code>.
     *
     * @throwsa IllegalArgumentException if source or target vertices are not
     * found in the graph.
     * @throwsa NullPointerException if any of the specified vertices is <code>
     * null</code>.
     *
     * @see #getEdgeFactory()
     */
    public E addEdge(V sourceVertex, V targetVertex) throws IllegalArgumentException ;
     ...
     * @throwsa IllegalArgumentException if source or target vertices are not
     * found in the graph.
     * @throwsa ClassCastException if the specified edge is not assignment
     ...
     * @see #getEdgeFactory()
     */
    public boolean addEdge(V sourceVertex, V targetVertex, E e) throws IllegalArgumentException, ClassCastException;
     ...
     * vertex.
     *
     * @throwsa NullPointerException if the specified vertex is <code>
     * null</code>.
     */
     ...
     *
     * @throwsa IllegalArgumentException if vertex is not found in the graph.
     * @throwsa NullPointerException if vertex is <code>null</code>.
     */
    public Set<E> edgesOf(V vertex) throws IllegalArgumentException ;
     ...
     *
     * @throwsa NullPointerException if the specified edge collection is <tt>
     * null</tt>.
     *
     ...
     * @return <tt>true</tt> if this graph changed as a result of the call
     *
     * @throwsa NullPointerException if the specified vertex collection is <tt>
     * null</tt>.
     *
