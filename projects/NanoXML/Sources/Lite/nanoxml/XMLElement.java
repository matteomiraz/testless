 ...
 * Enumeration _enum = element.getAttributeNames();<BR>
 * while (_enum.hasMoreElements()) {<BR>
 * &nbsp;&nbsp;&nbsp;&nbsp;String key = (String) _enum.nextElement();<BR>
...
public class XMLElement
{
                         ...
                         boolean   ignoreCase)
    {
        ...
        this.lineNr = 0;
        Enumeration _enum = this.entities.keys();
        ...
        throws IOException
    {
        ...
        if ((this.contents != null) && (this.contents.length() > 0)) {
            ...
            writer.write('>');
            Enumeration _enum = this.enumerateChildren();
            while (_enum.hasMoreElements()) {
    ...
    public void testful_parseCharArray(tful.arrays.charArray p0, int p1, int p2) throws nanoxml.XMLParseException { parseCharArray(p0.toArray() , p1, p2); }
    public void testful_parseCharArray(tful.arrays.charArray p0, int p1, int p2, int p3) throws nanoxml.XMLParseException { parseCharArray(p0.toArray() , p1, p2, p3); }
