    ...
    implements Map<K,V>, java.io.Serializable, Cloneable
{
     ...
     * @throwsa IllegalArgumentException if <tt>expectedMaxSize</tt> is negative
     */
    public IdentityHashMap(int expectedMaxSize) throws IllegalArgumentException{
    	tful.Contracts.assertSmall(expectedMaxSize);
    ...
    private class KeySet extends AbstractSet<K> {
         ...
         */
        public boolean removeAll(Collection<?> c) throws java.lang.ClassCastException{
