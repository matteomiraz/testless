...
public interface ListIterator<E> extends Iterator<E> {
     ...
     * @exceptiona NoSuchElementException if the iteration has no next element.
     */
     ...
     *
     * @exceptiona NoSuchElementException if the iteration has no previous
     *            element.
     */
     ...
     * @exceptiona IllegalStateException neither <tt>next</tt> nor
     ...
     *          <tt>next</tt> or <tt>previous</tt>.
     * @exceptiona UnsupportedOperationException if the <tt>set</tt> operation
     * 		  is not supported by this list iterator.
     * @exceptiona ClassCastException if the class of the specified element
     * 		  prevents it from being added to this list.
     * @exceptiona IllegalArgumentException if some aspect of the specified
     *		  element prevents it from being added to this list.
     * @exceptiona IllegalStateException if neither <tt>next</tt> nor
     *	          <tt>previous</tt> have been called, or <tt>remove</tt> or
     *		  <tt>add</tt> have been called after the last call to
     * 		  <tt>next</tt> or <tt>previous</tt>.
     */
    void set(E e) throws UnsupportedOperationException, ClassCastException, IllegalArgumentException, IllegalStateException;
     ...
     * @exceptiona UnsupportedOperationException if the <tt>add</tt> method is
     * 		  not supported by this list iterator.
     *
     * @exceptiona ClassCastException if the class of the specified element
     * 		  prevents it from being added to this list.
     *
     * @exceptiona IllegalArgumentException if some aspect of this element
     *            prevents it from being added to this list.
     */
    void add(E e) throws UnsupportedOperationException, ClassCastException, IllegalArgumentException;
}
