...
public class BitSet implements Cloneable, java.io.Serializable {
     ...
     * @exceptiona NegativeArraySizeException if the specified initial size
     *               is negative.
     */
    public BitSet(int nbits) throws NegativeArraySizeException {
    	tful.Contracts.assertSmall(nbits);
     ...
     * @exceptiona IndexOutOfBoundsException if the specified index is negative.
     * @since   1.4
     */
    public void flip(int bitIndex) throws IndexOutOfBoundsException{
    	tful.Contracts.assertSmall(bitIndex);
     ...
     * @exceptiona IndexOutOfBoundsException if <tt>fromIndex</tt> is negative,
     *            or <tt>toIndex</tt> is negative, or <tt>fromIndex</tt> is
     *            larger than <tt>toIndex</tt>.
     * @since   1.4
     */
    public void flip(int fromIndex, int toIndex) throws IndexOutOfBoundsException {
    	tful.Contracts.assertSmall(fromIndex);
    	tful.Contracts.assertSmall(toIndex);
     ...
     * @since   1.4
     */
    public BitSet get(int fromIndex, int toIndex) throws IndexOutOfBoundsException {
	checkInvariants();
     ...
     * @since   1.4
     */
    public int nextSetBit(int fromIndex) throws IndexOutOfBoundsException {
	if (fromIndex < 0)
	    throw new IndexOutOfBoundsException("fromIndex < 0: " + fromIndex);
