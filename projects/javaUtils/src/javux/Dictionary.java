...
class Dictionary<K,V> {
     ...
     *          this dictionary.
     * @exceptiona NullPointerException if the <tt>key</tt> is <tt>null</tt>.
     ...
     * @exceptiona NullPointerException  if the <code>key</code> or
     ...
     *          mapping.
     * @exceptiona NullPointerException if <tt>key</tt> is <tt>null</tt>.
     */
