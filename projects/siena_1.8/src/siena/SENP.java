...
public class SENP {
    ...
    public static boolean testful_match(byteArray x, byteArray y) {
    	return match(x.toArray(), y.toArray());
    }
    ...
    public static byteArray testful_encode(AttributeValue a) {
    	return new byteArray(encode(a));
    }
    ...
    public static byteArray testful_encode(SENPPacket p) {
    	return new byteArray(encode(p));
    }
    ...
    public static byteArray testful_encode(Event p) {
    	return new byteArray(encode(p));
    }
    ...
    public static byteArray testful_encode(Filter p) {
    	return new byteArray(encode(p));
    }
    ...
    public static byteArray testful_encode(AttributeConstraint p) {
    	return new byteArray(encode(p));
    }
    ...
    public static SENPPacket testful_decode(byteArray pkt) throws SENPInvalidFormat {
    	return decode(pkt.toArray());
    }
    ...
    public static tful.arrays.byteArray testful_encode(long p0)  { return new tful.arrays.byteArray (encode(p0)); }
