...
//		if the value is not found, return -1
	...
	public OrdSet(tful.arrays.intArray p0)  { this(p0.toArray() ); }
	public tful.arrays.intArray testful_getSetElements()  { return new tful.arrays.intArray(getSetElements( ));}
