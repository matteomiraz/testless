...
public class PolynomialSplineFunction
     ...
     * @return the value
     */
    public double value(double v) throws FunctionEvaluationException, org.apache.commons.math.FunctionEvaluationException {
    ...
    public tful.arrays.doubleArray testful_getKnots()  { return new tful.arrays.doubleArray(getKnots( ));}

    public PolynomialSplineFunction(tful.arrays.doubleArray p0, tful.arrays.PolynomialFunctionArray p1)  { this(p0.toArray() , p1.toArray() ); }
    public tful.arrays.PolynomialFunctionArray testful_getPolynomials()  { return new tful.arrays.PolynomialFunctionArray (getPolynomials()); }
}
