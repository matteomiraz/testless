...
public class PolynomialFunctionLagrangeForm implements UnivariateRealFunction {
    ...
    public PolynomialFunctionLagrangeForm(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException { this(p0.toArray() , p1.toArray() ); }
    public static double testful_evaluate(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1, double p2) throws org.apache.commons.math.DuplicateSampleAbscissaException, java.lang.IllegalArgumentException { return evaluate( p0.toArray() , p1.toArray() , p2);}
    public tful.arrays.doubleArray testful_getCoefficients()  { return new tful.arrays.doubleArray(getCoefficients( ));}
    public static void testful_verifyInterpolationArray(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException { verifyInterpolationArray( p0.toArray() , p1.toArray() );}
    public tful.arrays.doubleArray testful_getInterpolatingPoints()  { return new tful.arrays.doubleArray(getInterpolatingPoints( ));}
    public tful.arrays.doubleArray testful_getInterpolatingValues()  { return new tful.arrays.doubleArray(getInterpolatingValues( ));}
