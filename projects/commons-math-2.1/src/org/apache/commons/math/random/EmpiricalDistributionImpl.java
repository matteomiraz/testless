...
public class EmpiricalDistributionImpl implements Serializable, EmpiricalDistribution {
     ...
     * @throwsa IllegalStateException if the distribution has not been loaded
     */
    public StatisticalSummary getSampleStats() throws java.lang.IllegalStateException {
        return sampleStats;
    }
    ...
    public void testful_load(tful.arrays.doubleArray p0)  { load( p0.toArray() );}
    public tful.arrays.doubleArray testful_getUpperBounds()  { return new tful.arrays.doubleArray(getUpperBounds( ));}
    public tful.arrays.doubleArray testful_getGeneratorUpperBounds()  { return new tful.arrays.doubleArray(getGeneratorUpperBounds( ));}
}
