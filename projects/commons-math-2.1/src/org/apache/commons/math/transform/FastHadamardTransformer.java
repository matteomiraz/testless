...
public class FastHadamardTransformer implements RealTransformer {
    ...
    public tful.arrays.intArray testful_transform(tful.arrays.intArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.intArray(transform( p0.toArray() ));}
