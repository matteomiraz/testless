...
public class FastFourierTransformer implements Serializable {
    ...
    private static class MultiDimensionalComplexMatrix
        ...
        public Object clone() {
			...
			MultiDimensionalComplexMatrix mdcm =
                    new MultiDimensionalComplexMatrix(java.lang.reflect.Array.newInstance(
    ...
    public static tful.arrays.doubleArray testful_sample(org.apache.commons.math.analysis.UnivariateRealFunction p0, double p1, double p2, int p3) throws org.apache.commons.math.FunctionEvaluationException, java.lang.IllegalArgumentException { return new tful.arrays.doubleArray(sample( p0, p1, p2, p3));}
    public static tful.arrays.doubleArray testful_scaleArray(tful.arrays.doubleArray p0, double p1)  { return new tful.arrays.doubleArray(scaleArray( p0.toArray() , p1));}
    public static void testful_verifyDataSet(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { verifyDataSet( p0.toArray() );}
    public static void testful_verifyDataSet(tful.arrays.ObjectArray p0) throws java.lang.IllegalArgumentException { verifyDataSet( p0.toArray() );}

    public tful.arrays.ComplexArray testful_transform(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (transform(p0.toArray() )); }
    public tful.arrays.ComplexArray testful_transform(org.apache.commons.math.analysis.UnivariateRealFunction p0, double p1, double p2, int p3) throws org.apache.commons.math.FunctionEvaluationException, java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (transform(p0, p1, p2, p3)); }
    public tful.arrays.ComplexArray testful_transform(tful.arrays.ComplexArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (transform(p0.toArray() )); }
    public tful.arrays.ComplexArray testful_transform2(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (transform2(p0.toArray() )); }
    public tful.arrays.ComplexArray testful_transform2(org.apache.commons.math.analysis.UnivariateRealFunction p0, double p1, double p2, int p3) throws org.apache.commons.math.FunctionEvaluationException, java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (transform2(p0, p1, p2, p3)); }
    public tful.arrays.ComplexArray testful_transform2(tful.arrays.ComplexArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (transform2(p0.toArray() )); }
    public static tful.arrays.ComplexArray testful_scaleArray(tful.arrays.ComplexArray p0, double p1)  { return new tful.arrays.ComplexArray (scaleArray(p0.toArray() , p1)); }
    public tful.arrays.ComplexArray testful_inversetransform(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (inversetransform(p0.toArray() )); }
    public tful.arrays.ComplexArray testful_inversetransform(org.apache.commons.math.analysis.UnivariateRealFunction p0, double p1, double p2, int p3) throws org.apache.commons.math.FunctionEvaluationException, java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (inversetransform(p0, p1, p2, p3)); }
    public tful.arrays.ComplexArray testful_inversetransform(tful.arrays.ComplexArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (inversetransform(p0.toArray() )); }
    public tful.arrays.ComplexArray testful_inversetransform2(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (inversetransform2(p0.toArray() )); }
    public tful.arrays.ComplexArray testful_inversetransform2(org.apache.commons.math.analysis.UnivariateRealFunction p0, double p1, double p2, int p3) throws org.apache.commons.math.FunctionEvaluationException, java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (inversetransform2(p0, p1, p2, p3)); }
    public tful.arrays.ComplexArray testful_inversetransform2(tful.arrays.ComplexArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.ComplexArray (inversetransform2(p0.toArray() )); }
