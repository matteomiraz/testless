...
public class SimpleEstimationProblem implements EstimationProblem {
    ...
    public tful.arrays.WeightedMeasurementArray testful_getMeasurements()  { return new tful.arrays.WeightedMeasurementArray (getMeasurements()); }
    public tful.arrays.EstimatedParameterArray testful_getUnboundParameters()  { return new tful.arrays.EstimatedParameterArray (getUnboundParameters()); }
    public tful.arrays.EstimatedParameterArray testful_getAllParameters()  { return new tful.arrays.EstimatedParameterArray (getAllParameters()); }
}
