...
public class ResizableDoubleArray implements DoubleArray, Serializable {
    ...
    public ResizableDoubleArray(int initialCapacity) {
    	Contracts.assertSmall(initialCapacity);
    ...
    * <p>
    ...
    public synchronized tful.arrays.doubleArray testful_getElements()  { return new tful.arrays.doubleArray(getElements( ));}
    public synchronized tful.arrays.doubleArray testful_getValues()  { return new tful.arrays.doubleArray(getValues( ));}
    public synchronized tful.arrays.doubleArray testful_getInternalValues()  { return new tful.arrays.doubleArray(getInternalValues( ));}
}
