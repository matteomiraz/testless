...
public final class MathUtils {
    ...
    public static int testful_hash(tful.arrays.doubleArray p0)  { return hash( p0.toArray() );}
    public static tful.arrays.doubleArray testful_normalizeArray(tful.arrays.doubleArray p0, double p1) throws java.lang.ArithmeticException, java.lang.IllegalArgumentException { return new tful.arrays.doubleArray(normalizeArray( p0.toArray() , p1));}
    public static double testful_distance1(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1)  { return distance1( p0.toArray() , p1.toArray() );}
    public static int testful_distance1(tful.arrays.intArray p0, tful.arrays.intArray p1)  { return distance1( p0.toArray() , p1.toArray() );}
    public static double testful_distance(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1)  { return distance( p0.toArray() , p1.toArray() );}
    public static double testful_distance(tful.arrays.intArray p0, tful.arrays.intArray p1)  { return distance( p0.toArray() , p1.toArray() );}
    public static double testful_distanceInf(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1)  { return distanceInf( p0.toArray() , p1.toArray() );}
    public static int testful_distanceInf(tful.arrays.intArray p0, tful.arrays.intArray p1)  { return distanceInf( p0.toArray() , p1.toArray() );}
    public static void testful_checkOrder(tful.arrays.doubleArray p0, int p1, boolean p2)  { checkOrder( p0.toArray() , p1, p2);}
}
