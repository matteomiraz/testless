...
public class BigReal implements FieldElement<BigReal>, Comparable<BigReal>, Serializable {
    ...
    public BigReal(tful.arrays.charArray p0)  { this(p0.toArray() ); }
    public BigReal(tful.arrays.charArray p0, int p1, int p2)  { this(p0.toArray() , p1, p2); }
    public BigReal(tful.arrays.charArray p0, int p1, int p2, java.math.MathContext p3)  { this(p0.toArray() , p1, p2, p3); }
    public BigReal(tful.arrays.charArray p0, java.math.MathContext p1)  { this(p0.toArray() , p1); }

    private static java.math.RoundingMode testful_convert_RoundingMode(short s) {switch(s%8) { default: return java.math.RoundingMode.UP; case 1: return java.math.RoundingMode.DOWN; case 2: return java.math.RoundingMode.CEILING; case 3: return java.math.RoundingMode.FLOOR; case 4: return java.math.RoundingMode.HALF_UP; case 5: return java.math.RoundingMode.HALF_DOWN; case 6: return java.math.RoundingMode.HALF_EVEN; case 7: return java.math.RoundingMode.UNNECESSARY; }  }
    public void testful_setRoundingMode(short p0)  { setRoundingMode( testful_convert_RoundingMode(p0) ); }
