...
public class ChiSquareTestImpl implements UnknownDistributionChiSquareTest {
    ...
    public double testful_chiSquare(tful.arrays.doubleArray p0, tful.arrays.longArray p1) throws java.lang.IllegalArgumentException { return chiSquare( p0.toArray() , p1.toArray() );}
    public double testful_chiSquareTest(tful.arrays.doubleArray p0, tful.arrays.longArray p1) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return chiSquareTest( p0.toArray() , p1.toArray() );}
    public boolean testful_chiSquareTest(tful.arrays.doubleArray p0, tful.arrays.longArray p1, double p2) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return chiSquareTest( p0.toArray() , p1.toArray() , p2);}
    public double testful_chiSquareDataSetsComparison(tful.arrays.longArray p0, tful.arrays.longArray p1) throws java.lang.IllegalArgumentException { return chiSquareDataSetsComparison( p0.toArray() , p1.toArray() );}
    public double testful_chiSquareTestDataSetsComparison(tful.arrays.longArray p0, tful.arrays.longArray p1) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return chiSquareTestDataSetsComparison( p0.toArray() , p1.toArray() );}
    public boolean testful_chiSquareTestDataSetsComparison(tful.arrays.longArray p0, tful.arrays.longArray p1, double p2) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return chiSquareTestDataSetsComparison( p0.toArray() , p1.toArray() , p2);}


    public double testful_chiSquare(tful.arrays.longArrayArray p0) throws java.lang.IllegalArgumentException { return chiSquare(p0.toArray() ); }
    public double testful_chiSquareTest(tful.arrays.longArrayArray p0) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return chiSquareTest(p0.toArray() ); }
    public boolean testful_chiSquareTest(tful.arrays.longArrayArray p0, double p1) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return chiSquareTest(p0.toArray() , p1); }
}
