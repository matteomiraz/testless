...
public class Variance extends AbstractStorelessUnivariateStatistic implements Serializable, WeightedEvaluation {
    ...
    public double testful_evaluate(tful.arrays.doubleArray p0, double p1, int p2, int p3)  { return evaluate( p0.toArray() , p1, p2, p3);}
    public double testful_evaluate(tful.arrays.doubleArray p0, double p1)  { return evaluate( p0.toArray() , p1);}
    public double testful_evaluate(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1, double p2, int p3, int p4)  { return evaluate( p0.toArray() , p1.toArray() , p2, p3, p4);}
    public double testful_evaluate(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1, double p2)  { return evaluate( p0.toArray() , p1.toArray() , p2);}
