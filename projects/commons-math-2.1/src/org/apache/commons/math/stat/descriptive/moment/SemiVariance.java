 ...
 *
 * @version $Revision: 917275 $ $Date: 2010-02-28 14:43:11 -0500 (Sun, 28 Feb 2010) $
 * @since 2.1
 */
...
public class SemiVariance extends AbstractUnivariateStatistic implements Serializable {
    ...
    public enum Direction {
        ...
        public static tful.arrays.DirectionArray testful_values()  { return new tful.arrays.DirectionArray (values()); }
    ...
    public double testful_evaluate(tful.arrays.doubleArray p0, org.apache.commons.math.stat.descriptive.moment.SemiVariance.Direction p1)  { return evaluate( p0.toArray() , p1);}
    public double testful_evaluate(tful.arrays.doubleArray p0, double p1)  { return evaluate( p0.toArray() , p1);}
    public double testful_evaluate(tful.arrays.doubleArray p0, double p1, org.apache.commons.math.stat.descriptive.moment.SemiVariance.Direction p2)  { return evaluate( p0.toArray() , p1, p2);}
    public double testful_evaluate(tful.arrays.doubleArray p0, double p1, org.apache.commons.math.stat.descriptive.moment.SemiVariance.Direction p2, boolean p3, int p4, int p5)  { return evaluate( p0.toArray() , p1, p2, p3, p4, p5);}

    private static org.apache.commons.math.stat.descriptive.moment.SemiVariance.Direction testful_convert_Direction(short s) {switch(s%2) { default: return org.apache.commons.math.stat.descriptive.moment.SemiVariance.Direction.UPSIDE; case 1: return org.apache.commons.math.stat.descriptive.moment.SemiVariance.Direction.DOWNSIDE;  } }
    public SemiVariance(short p0)  { this( testful_convert_Direction(p0) ); }
    public SemiVariance(boolean p0, short p1)  { this(p0,  testful_convert_Direction(p1) ); }
    public double testful_evaluate(double[] p0, short p1)  { return evaluate(p0,  testful_convert_Direction(p1) ); }
    public double testful_evaluate(double[] p0, double p1, short p2)  { return evaluate(p0, p1,  testful_convert_Direction(p2) ); }
    public double testful_evaluate(double[] p0, double p1, short p2, boolean p3, int p4, int p5)  { return evaluate(p0, p1,  testful_convert_Direction(p2) , p3, p4, p5); }
    public double testful_testful_evaluate(tful.arrays.doubleArray p0, short p1)  { return testful_evaluate(p0,  testful_convert_Direction(p1) ); }
    public double testful_testful_evaluate(tful.arrays.doubleArray p0, double p1, short p2)  { return testful_evaluate(p0, p1,  testful_convert_Direction(p2) ); }
    public double testful_testful_evaluate(tful.arrays.doubleArray p0, double p1, short p2, boolean p3, int p4, int p5)  { return testful_evaluate(p0, p1,  testful_convert_Direction(p2) , p3, p4, p5); }
    public void testful_setVarianceDirection(short p0)  { setVarianceDirection( testful_convert_Direction(p0) ); }
