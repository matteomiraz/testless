...
public class MultivariateSummaryStatistics
  implements StatisticalMultivariateSummary, Serializable {
    ...
    public tful.arrays.doubleArray testful_getMin()  { return new tful.arrays.doubleArray(getMin( ));}
    public tful.arrays.doubleArray testful_getMax()  { return new tful.arrays.doubleArray(getMax( ));}
    public tful.arrays.doubleArray testful_getStandardDeviation()  { return new tful.arrays.doubleArray(getStandardDeviation( ));}
    public tful.arrays.doubleArray testful_getMean()  { return new tful.arrays.doubleArray(getMean( ));}
    public tful.arrays.doubleArray testful_getSum()  { return new tful.arrays.doubleArray(getSum( ));}
    public void testful_addValue(tful.arrays.doubleArray p0) throws org.apache.commons.math.DimensionMismatchException { addValue( p0.toArray() );}
    public tful.arrays.doubleArray testful_getGeometricMean()  { return new tful.arrays.doubleArray(getGeometricMean( ));}
    public tful.arrays.doubleArray testful_getSumSq()  { return new tful.arrays.doubleArray(getSumSq( ));}
    public tful.arrays.doubleArray testful_getSumLog()  { return new tful.arrays.doubleArray(getSumLog( ));}


    public tful.arrays.StorelessUnivariateStatisticArray testful_getSumImpl()  { return new tful.arrays.StorelessUnivariateStatisticArray (getSumImpl()); }
    public void testful_setSumImpl(tful.arrays.StorelessUnivariateStatisticArray p0) throws org.apache.commons.math.DimensionMismatchException { setSumImpl(p0.toArray() ); }
    public tful.arrays.StorelessUnivariateStatisticArray testful_getSumsqImpl()  { return new tful.arrays.StorelessUnivariateStatisticArray (getSumsqImpl()); }
    public void testful_setSumsqImpl(tful.arrays.StorelessUnivariateStatisticArray p0) throws org.apache.commons.math.DimensionMismatchException { setSumsqImpl(p0.toArray() ); }
    public tful.arrays.StorelessUnivariateStatisticArray testful_getMinImpl()  { return new tful.arrays.StorelessUnivariateStatisticArray (getMinImpl()); }
    public void testful_setMinImpl(tful.arrays.StorelessUnivariateStatisticArray p0) throws org.apache.commons.math.DimensionMismatchException { setMinImpl(p0.toArray() ); }
    public tful.arrays.StorelessUnivariateStatisticArray testful_getMaxImpl()  { return new tful.arrays.StorelessUnivariateStatisticArray (getMaxImpl()); }
    public void testful_setMaxImpl(tful.arrays.StorelessUnivariateStatisticArray p0) throws org.apache.commons.math.DimensionMismatchException { setMaxImpl(p0.toArray() ); }
    public tful.arrays.StorelessUnivariateStatisticArray testful_getSumLogImpl()  { return new tful.arrays.StorelessUnivariateStatisticArray (getSumLogImpl()); }
    public void testful_setSumLogImpl(tful.arrays.StorelessUnivariateStatisticArray p0) throws org.apache.commons.math.DimensionMismatchException { setSumLogImpl(p0.toArray() ); }
    public tful.arrays.StorelessUnivariateStatisticArray testful_getGeoMeanImpl()  { return new tful.arrays.StorelessUnivariateStatisticArray (getGeoMeanImpl()); }
    public void testful_setGeoMeanImpl(tful.arrays.StorelessUnivariateStatisticArray p0) throws org.apache.commons.math.DimensionMismatchException { setGeoMeanImpl(p0.toArray() ); }
    public tful.arrays.StorelessUnivariateStatisticArray testful_getMeanImpl()  { return new tful.arrays.StorelessUnivariateStatisticArray (getMeanImpl()); }
    public void testful_setMeanImpl(tful.arrays.StorelessUnivariateStatisticArray p0) throws org.apache.commons.math.DimensionMismatchException { setMeanImpl(p0.toArray() ); }
