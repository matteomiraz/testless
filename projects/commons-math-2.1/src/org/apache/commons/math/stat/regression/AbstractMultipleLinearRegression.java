...
public abstract class AbstractMultipleLinearRegression implements
    ...
    public void newSampleData(double[] data, int nobs, int nvars) {
    	Contracts.assertSmall(nobs);
    	Contracts.assertSmall(nvars);
    ...
    public void testful_newSampleData(tful.arrays.doubleArray p0, int p1, int p2)  { newSampleData( p0.toArray() , p1, p2);}
    public tful.arrays.doubleArray testful_estimateRegressionParameters()  { return new tful.arrays.doubleArray(estimateRegressionParameters( ));}
    public tful.arrays.doubleArray testful_estimateResiduals()  { return new tful.arrays.doubleArray(estimateResiduals( ));}
    public tful.arrays.doubleArray testful_estimateRegressionParametersStandardErrors()  { return new tful.arrays.doubleArray(estimateRegressionParametersStandardErrors( ));}
    public tful.arrays.doubleArrayArray testful_estimateRegressionParametersVariance()  { return new tful.arrays.doubleArrayArray (estimateRegressionParametersVariance()); }
