...
public class TTestImpl implements TTest  {
    ...
    public double testful_t(double p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException { return t( p0, p1.toArray() );}
    public double testful_t(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException { return t( p0.toArray() , p1.toArray() );}
    public double testful_tTest(double p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return tTest( p0, p1.toArray() );}
    public boolean testful_tTest(double p0, tful.arrays.doubleArray p1, double p2) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return tTest( p0, p1.toArray() , p2);}
    public double testful_tTest(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return tTest( p0.toArray() , p1.toArray() );}
    public boolean testful_tTest(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1, double p2) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return tTest( p0.toArray() , p1.toArray() , p2);}
    public double testful_homoscedasticT(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException { return homoscedasticT( p0.toArray() , p1.toArray() );}
    public double testful_homoscedasticTTest(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return homoscedasticTTest( p0.toArray() , p1.toArray() );}
    public boolean testful_homoscedasticTTest(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1, double p2) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return homoscedasticTTest( p0.toArray() , p1.toArray() , p2);}
    public double testful_pairedT(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return pairedT( p0.toArray() , p1.toArray() );}
    public double testful_pairedTTest(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return pairedTTest( p0.toArray() , p1.toArray() );}
    public boolean testful_pairedTTest(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1, double p2) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException { return pairedTTest( p0.toArray() , p1.toArray() , p2);}
