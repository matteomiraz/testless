...
public class Covariance {
    ...
    public double testful_covariance(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1, boolean p2) throws java.lang.IllegalArgumentException { return covariance( p0.toArray() , p1.toArray() , p2);}
    public double testful_covariance(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1) throws java.lang.IllegalArgumentException { return covariance( p0.toArray() , p1.toArray() );}

    public Covariance(tful.arrays.doubleArrayArray p0, boolean p1)  { this(p0.toArray() , p1); }
    public Covariance(tful.arrays.doubleArrayArray p0)  { this(p0.toArray() ); }
