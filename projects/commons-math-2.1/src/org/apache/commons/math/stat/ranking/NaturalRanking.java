...
public class NaturalRanking implements RankingAlgorithm {
    ...
    public tful.arrays.doubleArray testful_rank(tful.arrays.doubleArray p0)  { return new tful.arrays.doubleArray(rank( p0.toArray() ));}

    private static org.apache.commons.math.stat.ranking.TiesStrategy testful_convert_TiesStrategy(short s) {switch(s%5) { default: return org.apache.commons.math.stat.ranking.TiesStrategy.SEQUENTIAL; case 1: return org.apache.commons.math.stat.ranking.TiesStrategy.MINIMUM; case 2: return org.apache.commons.math.stat.ranking.TiesStrategy.MAXIMUM; case 3: return org.apache.commons.math.stat.ranking.TiesStrategy.AVERAGE; case 4: return org.apache.commons.math.stat.ranking.TiesStrategy.RANDOM;  } }
    private static org.apache.commons.math.stat.ranking.NaNStrategy testful_convert_NaNStrategy(byte s) {switch(s%4) { default: return org.apache.commons.math.stat.ranking.NaNStrategy.MINIMAL; case 1: return org.apache.commons.math.stat.ranking.NaNStrategy.MAXIMAL; case 2: return org.apache.commons.math.stat.ranking.NaNStrategy.REMOVED; case 3: return org.apache.commons.math.stat.ranking.NaNStrategy.FIXED;  } }
    public NaturalRanking(short p0)  { this( testful_convert_TiesStrategy(p0) ); }
    public NaturalRanking(byte p0)  { this( testful_convert_NaNStrategy(p0) ); }
    public NaturalRanking(byte p0, short p1)  { this( testful_convert_NaNStrategy(p0) ,  testful_convert_TiesStrategy(p1) ); }
    public NaturalRanking(byte p0, org.apache.commons.math.random.RandomGenerator p1)  { this( testful_convert_NaNStrategy(p0) , p1); }
