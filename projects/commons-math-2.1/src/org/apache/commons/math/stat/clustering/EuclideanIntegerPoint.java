...
public class EuclideanIntegerPoint implements Clusterable<EuclideanIntegerPoint>, Serializable {
    ...
    public EuclideanIntegerPoint(tful.arrays.intArray p0)  { this(p0.toArray() ); }
    public tful.arrays.intArray testful_getPoint()  { return new tful.arrays.intArray(getPoint( ));}
