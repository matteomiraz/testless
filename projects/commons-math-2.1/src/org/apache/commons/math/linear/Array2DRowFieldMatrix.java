...
public class Array2DRowFieldMatrix<T extends FieldElement<T>> extends AbstractFieldMatrix<T> implements Serializable {
    ...
    public Array2DRowFieldMatrix(tful.arrays.FieldElementArrayArray<T> p0) throws java.lang.IllegalArgumentException, java.lang.NullPointerException { this(p0.toArray() ); }
    public Array2DRowFieldMatrix(tful.arrays.FieldElementArrayArray<T> p0, boolean p1) throws java.lang.IllegalArgumentException, java.lang.NullPointerException { this(p0.toArray() , p1); }
    public Array2DRowFieldMatrix(tful.arrays.FieldElementArray<T> p0)  { this(p0.toArray() ); }
    ...
    public tful.arrays.FieldElementArrayArray<T> testful_getDataRef()  { return new tful.arrays.FieldElementArrayArray<T> (getDataRef()); }
