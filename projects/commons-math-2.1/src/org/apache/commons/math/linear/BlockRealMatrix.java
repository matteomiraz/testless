...
public class BlockRealMatrix extends AbstractRealMatrix implements Serializable {
    ...
    public static double[][] createBlocksLayout(final int rows, final int columns) {
    	Contracts.assertSmall(rows);
    	Contracts.assertSmall(columns);
    ...
    public BlockRealMatrix(tful.arrays.doubleArrayArray p0) throws java.lang.IllegalArgumentException { this(p0.toArray() ); }
    public BlockRealMatrix(int p0, int p1, tful.arrays.doubleArrayArray p2, boolean p3) throws java.lang.IllegalArgumentException { this(p0, p1, p2.toArray() , p3); }
    ...
    public static tful.arrays.doubleArrayArray testful_createBlocksLayout(int p0, int p1)  { return new tful.arrays.doubleArrayArray (createBlocksLayout(p0, p1)); }
    public static tful.arrays.doubleArrayArray testful_toBlocksLayout(tful.arrays.doubleArrayArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.doubleArrayArray (toBlocksLayout(p0.toArray() )); }
}
