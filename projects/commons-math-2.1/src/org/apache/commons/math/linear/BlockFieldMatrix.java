...
public class BlockFieldMatrix<T extends FieldElement<T>> extends AbstractFieldMatrix<T> implements Serializable {
    ...
    public BlockFieldMatrix(tful.arrays.FieldElementArrayArray<T> p0) throws java.lang.IllegalArgumentException { this(p0.toArray() ); }
    public BlockFieldMatrix(int p0, int p1, tful.arrays.FieldElementArrayArray<T> p2, boolean p3) throws java.lang.IllegalArgumentException { this(p0, p1, p2.toArray() , p3); }
    ...
    public static <T extends FieldElement<T>> tful.arrays.FieldElementArrayArray<T> testful_createBlocksLayout(org.apache.commons.math.Field<T> p0, int p1, int p2)  { return new tful.arrays.FieldElementArrayArray<T> (createBlocksLayout(p0, p1, p2)); }
    public static <T extends FieldElement<T>> tful.arrays.FieldElementArrayArray<T> testful_toBlocksLayout(tful.arrays.FieldElementArrayArray<T> p0) throws java.lang.IllegalArgumentException { return new tful.arrays.FieldElementArrayArray<T> (toBlocksLayout(p0.toArray() )); }
