...
public abstract class AbstractFieldMatrix<T extends FieldElement<T>> implements FieldMatrix<T> {
    ...
    protected static <T extends FieldElement<T>> T[] buildArray(final Field<T> field,
                                                                final int length) {
        @SuppressWarnings({ "unchecked", "restriction" }) // OK because field must be correct class
    ...
    public FieldMatrix<T> getSubMatrix(final int[] selectedRows, final int[] selectedColumns)
        ...
        subMatrix.walkInOptimizedOrder(new DefaultFieldMatrixChangingVisitor<T>(field.getZero()) {
            ...
            /** {@inheritDoc} */
            @Override
            public T visit(final int row, final int column, final T value) throws org.apache.commons.math.linear.MatrixVisitorException{
    ...
    public void copySubMatrix(final int startRow, final int endRow,
        ...
        walkInOptimizedOrder(new DefaultFieldMatrixPreservingVisitor<T>(field.getZero()) {
            ...
            /** {@inheritDoc} */
            @Override
            public void visit(final int row, final int column, final T value) throws org.apache.commons.math.linear.MatrixVisitorException{
    ...
    public tful.arrays.FieldElementArrayArray<T> testful_getData()  { return new tful.arrays.FieldElementArrayArray<T> (getData()); }
    public tful.arrays.FieldElementArray<T> testful_preMultiply(tful.arrays.FieldElementArray<T> p0) throws java.lang.IllegalArgumentException { return new tful.arrays.FieldElementArray<T> (preMultiply(p0.toArray() )); }
    public void testful_copySubMatrix(int p0, int p1, int p2, int p3, tful.arrays.FieldElementArrayArray<T> p4) throws org.apache.commons.math.linear.MatrixIndexException, java.lang.IllegalArgumentException { copySubMatrix(p0, p1, p2, p3, p4.toArray() ); }
    public void testful_copySubMatrix(tful.arrays.intArray p0, tful.arrays.intArray p1, tful.arrays.FieldElementArrayArray<T> p2) throws org.apache.commons.math.linear.MatrixIndexException, java.lang.IllegalArgumentException { copySubMatrix(p0.toArray() , p1.toArray() , p2.toArray() ); }
    public void testful_setSubMatrix(tful.arrays.FieldElementArrayArray<T> p0, int p1, int p2) throws org.apache.commons.math.linear.MatrixIndexException { setSubMatrix(p0.toArray() , p1, p2); }
    public void testful_setRow(int p0, tful.arrays.FieldElementArray<T> p1) throws org.apache.commons.math.linear.MatrixIndexException, org.apache.commons.math.linear.InvalidMatrixException { setRow(p0, p1.toArray() ); }
    public void testful_setColumn(int p0, tful.arrays.FieldElementArray<T> p1) throws org.apache.commons.math.linear.MatrixIndexException, org.apache.commons.math.linear.InvalidMatrixException { setColumn(p0, p1.toArray() ); }
    public tful.arrays.FieldElementArray<T> testful_operate(tful.arrays.FieldElementArray<T> p0) throws java.lang.IllegalArgumentException { return new tful.arrays.FieldElementArray<T> (operate(p0.toArray() )); }

    public org.apache.commons.math.linear.FieldMatrix<T> testful_getSubMatrix(tful.arrays.intArray p0, tful.arrays.intArray p1) throws org.apache.commons.math.linear.MatrixIndexException { return getSubMatrix(p0.toArray() , p1.toArray() ); }
    public tful.arrays.FieldElementArray<T> testful_getRow(int p0) throws org.apache.commons.math.linear.MatrixIndexException { return new tful.arrays.FieldElementArray<T>(getRow(p0)); }
    public tful.arrays.FieldElementArray<T> testful_getColumn(int p0) throws org.apache.commons.math.linear.MatrixIndexException { return new tful.arrays.FieldElementArray<T>(getColumn(p0)); }
