...
public class ArrayFieldVector<T extends FieldElement<T>> implements FieldVector<T>, Serializable {
     ...
     * @return a new array
     */
    @SuppressWarnings({ "unchecked", "restriction" }) // field is of type T
   ...
   /** Find the orthogonal projection of this vector onto another vector.
    ...
    /** {@inheritDoc} */
    public FieldVector<T> getSubVector(int index, int n) throws org.apache.commons.math.linear.MatrixIndexException{
    ...
    /** {@inheritDoc} */
    public void setSubVector(int index, FieldVector<T> v) throws org.apache.commons.math.linear.MatrixIndexException {
        try {
            try {
    ...
    public ArrayFieldVector(tful.arrays.FieldElementArray<T> p0) throws java.lang.IllegalArgumentException { this(p0.toArray() ); }
    public ArrayFieldVector(tful.arrays.FieldElementArray<T> p0, boolean p1) throws java.lang.NullPointerException, java.lang.IllegalArgumentException { this(p0.toArray() , p1); }
    public ArrayFieldVector(tful.arrays.FieldElementArray<T> p0, int p1, int p2)  { this(p0.toArray() , p1, p2); }
    public ArrayFieldVector(org.apache.commons.math.linear.ArrayFieldVector<T> p0, tful.arrays.FieldElementArray<T> p1)  { this(p0, p1.toArray() ); }
    public ArrayFieldVector(tful.arrays.FieldElementArray<T> p0, org.apache.commons.math.linear.ArrayFieldVector<T> p1)  { this(p0.toArray() , p1); }
    public ArrayFieldVector(tful.arrays.FieldElementArray<T> p0, tful.arrays.FieldElementArray<T> p1)  { this(p0.toArray() , p1.toArray() ); }
    public org.apache.commons.math.linear.FieldVector<T> testful_add(tful.arrays.FieldElementArray<T> p0) throws java.lang.IllegalArgumentException { return add(p0.toArray() ); }
    public org.apache.commons.math.linear.FieldVector<T> testful_append(tful.arrays.FieldElementArray<T> p0)  { return append(p0.toArray() ); }
    public org.apache.commons.math.linear.FieldVector<T> testful_subtract(tful.arrays.FieldElementArray<T> p0) throws java.lang.IllegalArgumentException { return subtract(p0.toArray() ); }
    public org.apache.commons.math.FieldElement<T> testful_dotProduct(tful.arrays.FieldElementArray<T> p0) throws java.lang.IllegalArgumentException { return dotProduct(p0.toArray() ); }
    public org.apache.commons.math.linear.FieldVector<T> testful_ebeMultiply(tful.arrays.FieldElementArray<T> p0) throws java.lang.IllegalArgumentException { return ebeMultiply(p0.toArray() ); }
    public org.apache.commons.math.linear.FieldVector<T> testful_ebeDivide(tful.arrays.FieldElementArray<T> p0) throws java.lang.IllegalArgumentException { return ebeDivide(p0.toArray() ); }
    public org.apache.commons.math.linear.FieldVector<T> testful_projection(tful.arrays.FieldElementArray<T> p0) throws java.lang.IllegalArgumentException { return projection(p0.toArray() ); }
    public org.apache.commons.math.linear.FieldMatrix<T> testful_outerProduct(tful.arrays.FieldElementArray<T> p0) throws java.lang.IllegalArgumentException { return outerProduct(p0.toArray() ); }
    public void testful_setSubVector(int p0, tful.arrays.FieldElementArray<T> p1) throws org.apache.commons.math.linear.MatrixIndexException { setSubVector(p0, p1.toArray() ); }


    public tful.arrays.FieldElementArray<T> testful_toArray()  { return new tful.arrays.FieldElementArray<T>(toArray()); }
    public tful.arrays.FieldElementArray<T> testful_getData()  { return new tful.arrays.FieldElementArray<T>(getData()); }
    public tful.arrays.FieldElementArray<T> testful_getDataRef()  { return new tful.arrays.FieldElementArray<T>(getDataRef()); }
