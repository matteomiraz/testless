...
public class SparseFieldVector<T extends FieldElement<T>> implements FieldVector<T>, Serializable {
     ...
     * @return a new array
     */
    @SuppressWarnings({ "unchecked", "restriction" }) // field is type T
    ...
    public SparseFieldVector(org.apache.commons.math.Field<T> p0, tful.arrays.FieldElementArray<T> p1)  { this(p0, p1.toArray() ); }
