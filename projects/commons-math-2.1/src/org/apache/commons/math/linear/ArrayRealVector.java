...
public class ArrayRealVector extends AbstractRealVector implements Serializable {
   ...
   /** Find the orthogonal projection of this vector onto another vector.
    ...
    /** {@inheritDoc} */
    public RealVector getSubVector(int index, int n) throws org.apache.commons.math.linear.MatrixIndexException{
    ...
    /** {@inheritDoc} */
    @Override
    public void setSubVector(int index, RealVector v) throws org.apache.commons.math.linear.MatrixIndexException{
        try {
            try {
    ...
    public ArrayRealVector(tful.arrays.doubleArray p0)  { this(p0.toArray() ); }
    public ArrayRealVector(tful.arrays.doubleArray p0, boolean p1) throws java.lang.NullPointerException, java.lang.IllegalArgumentException { this(p0.toArray() , p1); }
    public ArrayRealVector(tful.arrays.doubleArray p0, int p1, int p2)  { this(p0.toArray() , p1, p2); }
    public ArrayRealVector(org.apache.commons.math.linear.ArrayRealVector p0, tful.arrays.doubleArray p1)  { this(p0, p1.toArray() ); }
    public ArrayRealVector(tful.arrays.doubleArray p0, org.apache.commons.math.linear.ArrayRealVector p1)  { this(p0.toArray() , p1); }
    public ArrayRealVector(tful.arrays.doubleArray p0, tful.arrays.doubleArray p1)  { this(p0.toArray() , p1.toArray() ); }
    public org.apache.commons.math.linear.RealVector testful_add(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return add( p0.toArray() );}
    public org.apache.commons.math.linear.RealVector testful_append(tful.arrays.doubleArray p0)  { return append( p0.toArray() );}
    public tful.arrays.doubleArray testful_toArray()  { return new tful.arrays.doubleArray(toArray( ));}
    public tful.arrays.doubleArray testful_getData()  { return new tful.arrays.doubleArray(getData( ));}
    public org.apache.commons.math.linear.RealVector testful_subtract(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return subtract( p0.toArray() );}
    public double testful_dotProduct(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return dotProduct( p0.toArray() );}
    public org.apache.commons.math.linear.RealVector testful_ebeMultiply(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return ebeMultiply( p0.toArray() );}
    public org.apache.commons.math.linear.RealVector testful_ebeDivide(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return ebeDivide( p0.toArray() );}
    public double testful_getDistance(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return getDistance( p0.toArray() );}
    public double testful_getL1Distance(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return getL1Distance( p0.toArray() );}
    public double testful_getLInfDistance(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return getLInfDistance( p0.toArray() );}
    public org.apache.commons.math.linear.RealVector testful_projection(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return projection( p0.toArray() );}
    public org.apache.commons.math.linear.RealMatrix testful_outerProduct(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return outerProduct( p0.toArray() );}
    public void testful_setSubVector(int p0, tful.arrays.doubleArray p1) throws org.apache.commons.math.linear.MatrixIndexException { setSubVector( p0, p1.toArray() );}
    public tful.arrays.doubleArray testful_getDataRef()  { return new tful.arrays.doubleArray(getDataRef( ));}
