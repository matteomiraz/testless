...
public class BigMatrixImpl implements BigMatrix, Serializable {
    ...
    public BigMatrixImpl(int rowDimension, int columnDimension) {
    	Contracts.assertSmall(columnDimension);
    	Contracts.assertSmall(rowDimension);
        if (rowDimension <= 0 ) {
    ...
    public org.apache.commons.math.linear.BigMatrix testful_getSubMatrix(tful.arrays.intArray p0, tful.arrays.intArray p1) throws org.apache.commons.math.linear.MatrixIndexException { return getSubMatrix( p0.toArray() , p1.toArray() );}
    public tful.arrays.doubleArray testful_getRowAsDoubleArray(int p0) throws org.apache.commons.math.linear.MatrixIndexException { return new tful.arrays.doubleArray(getRowAsDoubleArray( p0));}
    public tful.arrays.doubleArray testful_getColumnAsDoubleArray(int p0) throws org.apache.commons.math.linear.MatrixIndexException { return new tful.arrays.doubleArray(getColumnAsDoubleArray( p0));}

    public BigMatrixImpl(tful.arrays.BigDecimalArray p0)  { this(p0.toArray() ); }
    public tful.arrays.BigDecimalArray testful_preMultiply(tful.arrays.BigDecimalArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.BigDecimalArray (preMultiply(p0.toArray() )); }
    public tful.arrays.BigDecimalArray testful_getRow(int p0) throws org.apache.commons.math.linear.MatrixIndexException { return new tful.arrays.BigDecimalArray (getRow(p0)); }
    public tful.arrays.BigDecimalArray testful_getColumn(int p0) throws org.apache.commons.math.linear.MatrixIndexException { return new tful.arrays.BigDecimalArray (getColumn(p0)); }
    public tful.arrays.BigDecimalArray testful_operate(tful.arrays.BigDecimalArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.BigDecimalArray (operate(p0.toArray() )); }
    public tful.arrays.BigDecimalArray testful_operate(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException { return new tful.arrays.BigDecimalArray (operate(p0.toArray() )); }
    public tful.arrays.BigDecimalArray testful_solve(tful.arrays.BigDecimalArray p0) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException { return new tful.arrays.BigDecimalArray (solve(p0.toArray() )); }
    public tful.arrays.BigDecimalArray testful_solve(tful.arrays.doubleArray p0) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException { return new tful.arrays.BigDecimalArray (solve(p0.toArray() )); }


    public BigMatrixImpl(tful.arrays.BigDecimalArrayArray p0)  { this(p0.toArray() ); }
    public BigMatrixImpl(tful.arrays.BigDecimalArrayArray p0, boolean p1)  { this(p0.toArray() , p1); }
    public BigMatrixImpl(tful.arrays.doubleArrayArray p0)  { this(p0.toArray() ); }
    public BigMatrixImpl(tful.arrays.StringArrayArray p0)  { this(p0.toArray() ); }
    public tful.arrays.BigDecimalArrayArray testful_getData()  { return new tful.arrays.BigDecimalArrayArray (getData()); }
    public void testful_setSubMatrix(tful.arrays.BigDecimalArrayArray p0, int p1, int p2) throws org.apache.commons.math.linear.MatrixIndexException { setSubMatrix(p0.toArray() , p1, p2); }
    public tful.arrays.BigDecimalArrayArray testful_getDataRef()  { return new tful.arrays.BigDecimalArrayArray (getDataRef()); }
    public tful.arrays.doubleArrayArray testful_getDataAsDoubleArray()  { return new tful.arrays.doubleArrayArray (getDataAsDoubleArray()); }
