package intkey;
    ...
    public class BinarySearchTree
    {
        ...
        public static boolean repOK(BinaryNode t) {
        	return repOK(t,new Range());
        }

        public static boolean repOK(BinaryNode t, Range range) {
            if(t == null) {
                return true;
            }
            ...
            if(!repOK(t.left,range.setUpper(t.element))) return false;
            if(!repOK(t.right,range.setLower(t.element))) return false;
            return true;
        }
        /**
